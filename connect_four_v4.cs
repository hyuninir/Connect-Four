...
namespace ConnectFourGame
{
        ...
        private void LoadQuestions()
        {
            ...
            questions.Add(new Question(
                questionText:
                    ...
                    "emancipatiebeweging. Noem TWO concrete eisen of verworvenheden.\n" +
            ...
            questions.Add(new Question(
                questionText:
                    ...
                    "c) Geef TWO redenen waarom Europese landen streefden naar " +
                    "koloniën in Afrika.",
                answer:
                    "a) Tijdvak 8: Tijd van burgers en stoommachines (1800–1900).\n\n" +
            ...
            questions.Add(new Question(
                questionText:
                    ...
                    "TWO voorbeelden waaruit blijkt dat WO2 een totale oorlog was.\n" +
            ...
            questions.Add(new Question(
                questionText:
                    ...
                    "b) Noem TWO langetermijngevolgen van het gebruik van de atoombom voor " +
            ...
            questions.Add(new Question(
                questionText:
                    ...
                    "a) Noem TWO oorzaken voor de oprichting van de staat Israël na WO2.\n" +
            ...
            questions.Add(new Question(
                questionText:
                    ...
                    "19e eeuw.\n" +
                    "b) Noem TWO oorzaken van de slechte leefomstandigheden van " +
                    "arbeiders in de vroege industrie.\n" +
                    "c) Welke TWO politieke ideologieën ontstonden als reactie op " +
            ...
            questions.Add(new Question(
                questionText:
                    ...
                    "b) Geef TWO voorbeelden van nationale eenwording in de 19e eeuw.\n" +
    ...
    public class LoginForm : Form
    {
        ...
        public LoginForm()
        {
            ...
            btnLogin = new Button {
                Text = "Inloggen", Location = new Point(140, 215),
                Size = new Size(120, 38),
                BackColor = Color.FromArgb(74, 144, 226), ForeColor = Color.White,
    ...
    public class PlayerSelectionForm : Form
    {
        public PlayerSelectionForm(string username)
        {
            ...
            this.Controls.Add(new Label {
                ...
                AutoSize = true, Location = new Point(70, 35)
            });
            ...
            for (int i = 0; i < 3; i++) {
                int count = i + 2;
                var btn = new Button {
                    Text = labels[i], Location = new Point(120, 120 + i * 65),
    ...
    public class ColorSelectionForm : Form
    {
        ...
        public ColorSelectionForm(int players)
        {
            ...
            lblInstruction = new Label {
                ...
                AutoSize = true, Location = new Point(200, 30)
            };
            ...
            btnStart = new Button {
                Text = "Start Spel", Location = new Point(260, 300), Size = new Size(150, 50),
                BackColor = Color.FromArgb(40, 167, 69), ForeColor = Color.White,
                FlatStyle = FlatStyle.Flat,
                Font = new Font("Comic Sans MS", 12, FontStyle.Bold), Enabled = false
            };
            btnStart.Click += (s, e) => {
    ...
    public class AnswerCheckForm : Form
    {
        ...
        public AnswerCheckForm(string playerAnswer, string correctAnswer)
        {
            ...
            var btnJ = new Button {
                Text = "✓  Juist", Location = new Point(80, y), Size = new Size(180, 52),
                BackColor = Color.FromArgb(40, 167, 69), ForeColor = Color.White,
                FlatStyle = FlatStyle.Flat,
                Font = new Font("Comic Sans MS", 12, FontStyle.Bold)
            };
            ...
            var btnO = new Button {
                Text = "✗  Onjuist", Location = new Point(330, y), Size = new Size(180, 52),
        ...
        private void AddBoldLabel(string text, int y) =>
            this.Controls.Add(new Label {
                Text = text, Font = new Font("Comic Sans MS", 11, FontStyle.Bold),
                Location = new Point(20, y), AutoSize = true
            });

        private void AddRtb(string text, Color bg, int y) =>
            this.Controls.Add(new RichTextBox {
                Text = text, Font = new Font("Comic Sans MS", 10),
                ReadOnly = true, BackColor = bg, BorderStyle = BorderStyle.FixedSingle,
                Location = new Point(20, y), Size = new Size(550, 85),
                ScrollBars = RichTextBoxScrollBars.Vertical
            });
    }
